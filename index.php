...
if (mysqli_num_rows($table_result) == 0) {
    echo "The 'posts' table doesn't exist in your database.";
    // You might need to create the table or fix the database name.
    // Exit the script or handle the error accordingly.
} else {
    // Proceed with your existing code to fetch data from the 'posts' table.
}
